...
// Produits de la catégorie Poissonnerie
$thon = new Poissonnerie("Thon", 30, 3, "Espagne", true, "Pêche Durable SA", "2025-01-12");
$cabillaud = new Poissonnerie("Cabillaud", 20, 1.5, "Norvège", false, "Océan Nordique", "2025-01-14");
$maquereau = new Poissonnerie("Maquereau", 12, 1, "France", true, "Atlantique Bio", "2025-01-15");
$bar = new Poissonnerie("Bar", 40, 2, "Portugal", false, "Pêcheur Atlantique", "2025-01-11");
